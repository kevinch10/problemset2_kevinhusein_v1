  ...
  if (status === 'empty') {
    return (
      <div
        ...
        role="status"
        aria-live="polite"
        className="bg-amber-50/80 border border-amber-200/90 rounded-2xl p-6 sm:p-8 text-center text-slate-800 shadow-xs space-y-3 my-6"
      >
        ...
        <p className="text-base sm:text-lg font-bold text-amber-950">
          No HDB resale transactions were found matching your selected town and flat type.
        </p>
        <p className="text-xs sm:text-sm text-amber-800/80 max-w-md mx-auto">
          Please adjust your town or flat-type filters to view recorded sales.
        </p>
        {onResetFilters && (
          <div className="pt-2">
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-amber-900 text-white text-xs font-bold hover:bg-amber-950 transition-colors cursor-pointer shadow-xs min-h-[44px]"
            >
